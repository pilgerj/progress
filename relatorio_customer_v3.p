           ...
           do:
              ...
              display "Total Pedido"    @ item.item-name
                      ACCUM TOTAL   BY order.order-num order-line.qty 
                                        @ order-line.qty
                      (ACCUM TOTAL BY order.order-num vtotal) / (ACCUM TOTAL   BY order.order-num order-line.qty )
                                        @ order-line.price
           ...
           do:
              ...
              display "Total Cliente"   @ item.item-name
                      ACCUM TOTAL BY customer.cust-num  order-line.qty 
                                        @ order-line.qty
                      (ACCUM TOTAL BY customer.cust-num vtotal) / (ACCUM TOTAL BY customer.cust-num  order-line.qty )
                                        @ order-line.price
        ...
        if last(customer.cust-num) then
           do:
              ...
              display "Total Geral"                  @ item.item-name
                     ...
                     (ACCUM TOTAL vtotal) / (ACCUM TOTAL order-line.qty) @ order-line.price
