     ...
     def var v-resposta        as   logical format "Sim/Não". 
     ...
     form v-cli_codigo      colon 15   
          ...
          v-cli_sexo        colon 15
          with frame f-cliente width 80 side-labels title " Exclusão de Clientes " three-d.
     ...
     repeat:
        ...
        display v-cli_nome       
         ...
         update v-resposta label "Deseja excluir o registro (Sim/Não) ? "
                with frame f-resposta row 21 no-box side-labels three-d.
                
         if v-resposta = yes then
            do:
               /* Verifica se não tem dados de movimento */
               delete cliente.
            end.
     end.
